...
namespace GyCPersonal.Web.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,descripcion,ultimoPrecioCoste,categoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,descripcion,ultimoPrecioCoste,categoriaId")] Producto producto)
        {
            if (ModelState.IsValid)
            {
